            ...
            <form action="" method="" @submit.prevent="submitreportproject()">
                ...
                <div class="group2">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="picker" v-model="reports.disadvantage" name="disadvantage" id="disadvantage" placeholder="Add your disadvantage"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="suggestion">Suggestion:</label>
                        <textarea class="picker" v-model="reports.suggestion" name="suggestion" id="suggestion" placeholder="Add your suggestion"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="plan_for_next_day">Plan For Next Day:</label>
                        <textarea class="picker" v-model="reports.plan_for_next_day" name="plan_for_next_day" id="plan_for_next_day" placeholder="Add your plan for next day"></textarea>
                    </div>
                </div>
